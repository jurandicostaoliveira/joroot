 ...
 * @JorootFramework(PHP e JAVASCRIPT) 
 * @Desenvolvido por.: Jurandi C. Oliveira
 * @E-mail.: jurandi@jurandioliveira.com.br
 * @copyright.: jurandioliveira.com.br
 * @disponivel em .: http://www.jurandioliveira.com.br/joroot
 * @atualizado em .: 09/2012 
 */
function isIE(){
    ...
    this.disableIE6 = function(){
        //verifica se o navegador ̩ Internet Explorer verṣo 6 ou anterior
        if((browser=="Microsoft Internet Explorer") && (brow_ver < 7)){
            //E apresenta uma msg de erro!
            ...
            var i = 0;
            for(i ; i < 4; i++){
                document.getElementsByTagName("a").item(i).style.color = "#CC3333";
            }
        }
    }
